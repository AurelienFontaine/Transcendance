...
// 		<div id="userInfo" class="mb-4 text-white" style="display:none;"><p><strong>Pseudo actuel :</strong> <span id="currentUsername"></span></p></div>

// 		<form id="changeUsername" style ="display:none";>
// 			<input id="newUsername" type="text" placeholder="Changer de pseudo" class="w-full p-2 rounded bg-gray-700 text-white" required />
  ...
  return `
    <div class="max-w-md mx-auto mt-8 p-6 bg-gray-800 rounded-lg shadow-md">
      ...
      <div id="userInfo" class="mb-4 text-white" style="display:none;">
        <p><strong>Pseudo actuel :</strong> <span id="currentUsername"></span></p>
      </div>
